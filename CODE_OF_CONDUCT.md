...
reported to the project maintainers via GitHub (open a confidential report through
the repository's Security → "Report a vulnerability" channel, or contact the
