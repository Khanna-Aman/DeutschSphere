...
const CACHE_VERSION = 'v6.7.0'; // v6.7.0: Bug fixes — CSP formsubmit, quiz image null guard, telemetry unhandledrejection, manifest icon purpose, SW CSS cache miss, state.deck stale ref
