...
- **Owner-action items (resolved 2026-07-01):** feedback email in `js/events.js` — owner elected to keep as-is; Imagen 3 redistribution — **confirmed permitted** under Google Cloud Vertex AI terms (customer owns output + may publish; indemnified), documented in `NOTICE` §3.
