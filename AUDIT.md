...
#### 🔴 Friction Points
* **Missing Illustrations in V1.0.0:** To guarantee a 100% 404-free E2E footprint, image illustrations are temporarily deactivated in V1.0.0. While the glassmorphic "Coming in V1.0.1" alert is elegant, the lack of immediate visual card cues is a cosmetic gap for visual learners.
