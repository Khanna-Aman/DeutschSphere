...
METAPHOR_MAP = {
    ...
    "ausgehen": "A stylish 3D modern double glass door swung wide open, with two cute glossy characters happily holding hands as they step through the doors onto a pathway under a starry night sky, with a soft golden light beam radiating from inside, completely wordless, no buildings or text signs, front-and-center, premium SOTA asset",
    ...
    "außer": "A group of four identical high-gloss 3D turquoise spheres sitting neatly in a row on a sleek black platform, except for one single sphere that is painted a vibrant glowing pink, positioned slightly elevated and offset on its own separate gold pedestal, representing exclusion or 'except', completely wordless, front-and-center, premium SOTA asset",
    "außerdem": "A beautiful 3D gift box with a pink glossy bow, with a giant sparkling golden '+' (plus) symbol floating and glowing directly above it, surrounded by flying stars, representing addition or besides, completely wordless, front-and-center, premium SOTA asset",
    "außerhalb": "A sleek 3D white spherical house with its door open, and a single vibrant glowing neon-magenta sphere floating peacefully on a grassy hill just outside of the door's threshold, representing outside of, completely wordless, front-and-center, premium SOTA asset",
    ...
    "babysitter": "A cute 3D character smilingly rocking a high-gloss pastel-blue baby cradle containing a sleeping baby icon, under a glowing warm crescent moon, representing care and babysitting, completely wordless, front-and-center, premium SOTA asset",
    ...
    "backen": "A stylized, premium 3D warm-glowing kitchen oven with a translucent glass door, showing a beautifully rising golden-brown loaf of bread on a tray inside, with tiny cute steam swirls floating out, representing baking, completely wordless, front-and-center, premium SOTA asset",
    ...
    "ball": "A highly polished, glossy 3D classic soccer ball with vibrant black and white hexagonal panels and shiny gold trim, floating suspended in mid-air, capturing pure play ball essence, front-and-center",
    ...
    "bauen": "A playful 3D construction scene where cute, miniature wooden crane arms are lifting a glossy, translucent blue glass block onto a half-constructed tower made of colorful toy bricks, representing building, completely wordless, front-and-center, premium SOTA asset",
    ...
    "baustelle": "A stylized 3D construction site segment with two glossy yellow-and-black striped safety barriers, a bright orange traffic cone with white bands, and a small pile of grey gravel on a dark platform, representing a construction site, completely wordless, front-and-center, premium SOTA asset",
    "beantworten": "A beautiful 3D speech bubble in vibrant neon green with a giant, glowing white checkmark symbol inside, responding to a small translucent purple question mark bubble in the background, representing answering a question, completely wordless, front-and-center, premium SOTA asset",
    ...
    "beenden": "A stunning 3D race checkered archway structure, a glossy red ribbon being sliced in half by a pair of golden scissors, with shiny golden confetti bursts floating in the air, representing completion, completely wordless, no text, front-and-center, premium SOTA asset",
    "beginnen": "A prominent wavy green 3D race-track flag waving, with a pristine red ribbon being sliced by gold scissors, representing the starting moment, completely wordless, no text, no letters, floating in mid-air, front-and-center",
    "begründen": "A highly polished 3D glowing green lightbulb connected by sleek glowing cables to three neat gold-rimmed documents with magnifying glasses over them, representing giving reasons or justifying, completely wordless, front-and-center, premium SOTA asset",
    ...
    "beliebt": "A giant glowing red 3D heart emoji floating high in the center, surrounded by many smaller cute, smiling 3D star characters looking up at it with admiration and waving, representing popularity, completely wordless, front-and-center, premium SOTA asset",
    ...
    "bequem": "A cute, happy 3D character resting peacefully, sinking into an incredibly soft, puffy, cloud-like pastel pink armchair with fluffy white clouds floating around it, representing pure comfort and relaxation, completely wordless, premium SOTA asset",
    "beraten": "A wise 3D master character with a warm glowing lightbulb above their head gently guiding and pointing a path on a holographic glowing blue map for a younger curious character, representing giving advice and counsel, completely wordless, premium SOTA asset",
    "der berg": "A majestic, snow-capped 3D mountain peak with warm golden sunlight hitting the summit, surrounded by miniature pine trees and tiny floating white clouds, capturing the pure essence of a mountain, completely wordless, premium SOTA asset",
    "berg": "A majestic, snow-capped 3D mountain peak with warm golden sunlight hitting the summit, surrounded by miniature pine trees and tiny floating white clouds, capturing the pure essence of a mountain, completely wordless, premium SOTA asset",
    "berichten": "A stylish 3D old-school news reporter microphone with golden frequencies radiating, in front of a miniature glowing translucent 3D broadcast tower emitting signal rings, completely wordless, premium SOTA asset",
    ...
    "berühmt": "A spectacular 3D walk of fame golden star on a dark marble tile, with bright warm spotlights beaming up from below casting sparkles into the air, representing being famous and well-known, completely wordless, premium SOTA asset",
    "der bescheid": "A beautiful 3D gold-rimmed document scroll rolled open, displaying a large glowing green checkmark wax seal on it, floating in mid-air with warm light, representing an official notice or decision, completely wordless, premium SOTA asset",
    "bescheid": "A beautiful 3D gold-rimmed document scroll rolled open, displaying a large glowing green checkmark wax seal on it, floating in mid-air with warm light, representing an official notice or decision, completely wordless, premium SOTA asset",
    "bescheid bekommen": "A cute 3D character looking happy as a glowing golden envelope with a tiny green notification bell icon hovers in front of them, emitting warm light rays, representing receiving a notification or being informed, completely wordless, premium SOTA asset",
    "bescheid geben / sagen": "A cute 3D character holding a glowing megaphone, sending a beautiful, sparkling golden paper airplane with a message symbol flying toward another character in the background, representing informing or letting someone know, completely wordless, premium SOTA asset",
    "beschreiben": "A beautiful 3D glossy hand holding a glowing neon-cyan pen, drawing highly detailed, sparkling dotted contour lines and descriptors around a translucent, cute 3D pink apple, representing describing or depicting something, completely wordless, premium SOTA asset",
    ...
    "besonders": "A row of four identical pastel grey 3D spheres, with one central sphere that is a spectacular, glowing translucent gold with beautiful internal sparkles and floating slightly higher, representing being special or particularly chosen, completely wordless, premium SOTA asset",
    ...
    "bestätigen": "A giant, vibrant green 3D checkmark icon popping out of a sleek glassmorphic check-box on a floating high-tech screen, surrounded by glowing golden particle bursts and sparkles, representing official confirmation, completely wordless, premium SOTA asset",
    "bestehen": "A beautifully rolled-up 3D graduation diploma scroll tied with a glossy red ribbon, sitting next to a glowing gold-rimmed document displaying a giant, vibrant green checkmark, representing passing an exam or succeeding, completely wordless, premium SOTA asset",
    "der besuch": "An open, inviting 3D front door of a cozy, glowing house, with a cute character waving a warm greeting to another character walking up the stone path, representing visitors and visit, completely wordless, premium SOTA asset",
    ...
    "die bewerbung": "A beautiful 3D glossy folder containing a gold-ribbon job application letter, next to a polished floating fountain pen and glowing star sparkles, representing a premium job application, completely wordless, premium SOTA asset",
    "bewerbung": "A beautiful 3D glossy folder containing a gold-ribbon job application letter, next to a polished floating fountain pen and glowing star sparkles, representing a premium job application, completely wordless, premium SOTA asset",
    "bewölkt": "A beautiful, puffy dark pastel grey 3D rain cloud floating in front of a translucent, glowing glassmorphic sun trying to peek through, representing cloudy or overcast skies, completely wordless, premium SOTA asset",
    ...
    "das blatt": "A magnificent, high-gloss 3D green Monstera leaf with intricate glowing gold veins, next to a pristine white floating sheet of paper, beautifully combining both meanings of a natural leaf and a paper sheet, completely wordless, premium SOTA asset",
    "blatt": "A magnificent, high-gloss 3D green Monstera leaf with intricate glowing gold veins, next to a pristine white floating sheet of paper, beautifully combining both meanings of a natural leaf and a paper sheet, completely wordless, premium SOTA asset",
    ...
    "der blog": "A beautiful, floating 3D computer screen displaying a sleek webpage layout with custom colorful 3D post-it notes, a giant glossy orange pencil, and warm lighting, representing a blog, completely wordless, premium SOTA asset",
    "blog": "A beautiful, floating 3D computer screen displaying a sleek webpage layout with custom colorful 3D post-it notes, a giant glossy orange pencil, and warm lighting, representing a blog, completely wordless, premium SOTA asset",
    "blond": "A cute, stylized 3D female head with gorgeous, flowing glossy golden-blonde hair styled in a chic bob, sparkling under soft warm studio spotlights against a black backdrop, completely wordless, premium SOTA asset",
    "die blume": "A giant, highly-detailed 3D flower blooming beautifully with large vibrant pink petals and a glossy gold center, floating in mid-air, front-and-center, 100% flower essence, premium SOTA asset",
    ...
    "die bohne": "A pair of fresh, glossy green 3D green bean pods, one slightly split open to reveal cute, perfectly detailed smooth green beans inside, floating with a warm self-illuminating glow against a black background, completely wordless, premium SOTA asset",
    "bohne": "A pair of fresh, glossy green 3D green bean pods, one slightly split open to reveal cute, perfectly detailed smooth green beans inside, floating with a warm self-illuminating glow against a black background, completely wordless, premium SOTA asset",
    "braten": "A beautiful 3D black cast iron frying pan floating in mid-air, with a perfectly sizzled, juicy 3D beef steak frying inside with rising heat waves and golden oil droplets, completely wordless, premium SOTA asset",
    "die bluse": "A beautiful, elegant 3D women's blouse made of soft, flowing pastel pink silk with glossy white buttons, floating gracefully on a simple gold-wire hanger in mid-air, completely wordless, premium SOTA asset",
    "bluse": "A beautiful, elegant 3D women's blouse made of soft, flowing pastel pink silk with glossy white buttons, floating gracefully on a simple gold-wire hanger in mid-air, completely wordless, premium SOTA asset",
    "blöd": "A comical and cute 3D character with a silly, cross-eyed expression, tongue sticking out slightly, wearing a colorful, oversized propeller beanie hat, representing silly or stupid, completely wordless, premium SOTA asset",
    ...
    "die brille": "A pair of highly stylish 3D modern spectacles with black-and-gold frames and translucent, glossy glass lenses casting realistic refractions, floating suspended in mid-air, completely wordless, premium SOTA asset",
    "brille": "A pair of highly stylish 3D modern spectacles with black-and-gold frames and translucent, glossy glass lenses casting realistic refractions, floating suspended in mid-air, completely wordless, premium SOTA asset",
    ...
    "die brücke": "A spectacular, elegant 3D architectural suspension bridge spanning over a smooth dark glossy river, glowing with warm ambient structural lighting along its cables, completely wordless, premium SOTA asset",
    "brücke": "A spectacular, elegant 3D architectural suspension bridge spanning over a smooth dark glossy river, glowing with warm ambient structural lighting along its cables, completely wordless, premium SOTA asset",
    ...
    "das buch": "A giant, magnificent 3D open book with thick, creamy-white blank pages slightly fluttering, bound in an ultra-glossy blue cover with gold metallic corners, floating suspended, front-and-center, capturing 100% book essence",
    "buchen": "An ultra-premium 3D golden ticket with a large glowing green checkmark symbol floating in front of a majestic, translucent glassmorphic calendar showing a marked date, completely wordless, premium SOTA asset",
    "verb:buchen": "An ultra-premium 3D golden ticket with a large glowing green checkmark symbol floating in front of a majestic, translucent glassmorphic calendar showing a marked date, completely wordless, premium SOTA asset",
    ...
    "der buchstabe": "A giant, colorful 3D capital letter 'A' made of ultra-glossy pink enamel and metallic gold edges, floating suspended in mid-air, completely wordless and front-and-center",
    ...
    "bunt": "A brilliant, glossy 3D artist paint palette splashing vibrant drops of hot pink, electric blue, canary yellow, and emerald green paint in mid-air, with a floating glass paint brush, capturing 100% colorful essence",
    "adjektiv:bunt": "A brilliant, glossy 3D artist paint palette splashing vibrant drops of hot pink, electric blue, canary yellow, and emerald green paint in mid-air, with a floating glass paint brush, capturing 100% colorful essence",
    "colorful": "A brilliant, glossy 3D artist paint palette splashing vibrant drops of hot pink, electric blue, canary yellow, and emerald green paint in mid-air, with a floating glass paint brush, capturing 100% colorful essence",
    ...
    "der bus": "A stunning, highly-detailed bright yellow 3D bus with glossy glass windows and chrome wheels, floating slightly tilted, capturing 100% bus essence, front-and-center",
    ...
    "die butter": "A block of rich, creamy golden 3D butter resting beautifully on a polished glass plate, with a small slice melting on top, floating in mid-air, front-and-center, 100% butter essence",
    ...
    "die bäckerei": "A highly stylized 3D bakery storefront with a striped awning and a completely wordless blank sign, warm glowing display windows showing miniature pastries and breads, absolutely no text, letters, or words on the sign, floating suspended, front-and-center",
    ...
    "adjektiv:böse": "A vibrant, cute red 3D emoji character with angry expressions, subtle smoke puffs coming out of its ears, floating in mid-air, front-and-center",
    "das büro": "A majestic 3D office desk setup floating in mid-air with a sleek laptop computer, a green desk plant, a warm glowing study lamp casting a soft light, and a stylish leather chair, completely wordless, premium SOTA asset",
    "büro": "A majestic 3D office desk setup floating in mid-air with a sleek laptop computer, a green desk plant, a warm glowing study lamp casting a soft light, and a stylish leather chair, completely wordless, premium SOTA asset",
    ...
    "das wiederhören": "A beautiful glossy 3D telephone receiver floating in mid-air, with beautiful glowing gold music notes and a cute waving hand silhouette emerging from the earpiece, completely wordless, front-and-center, premium SOTA asset",
    "wiederhören": "A beautiful glossy 3D telephone receiver floating in mid-air, with beautiful glowing gold music notes and a cute waving hand silhouette emerging from the earpiece, completely wordless, front-and-center, premium SOTA asset",
    "das wiedersehen": "Two cute, smiling 3D star characters waving goodbye to each other with warm smiles, with a glowing golden path looping around to bring them back together, completely wordless, front-and-center, premium SOTA asset",
    "wiedersehen": "Two cute, smiling 3D star characters waving goodbye to each other with warm smiles, with a glowing golden path looping around to bring them back together, completely wordless, front-and-center, premium SOTA asset",
    "willkommen": "A majestic 3D red carpet rolling out from a beautiful, open arched doorway with glowing golden light, with small floating star sparkles, completely wordless, front-and-center, premium SOTA asset",
    "der wind": "A cute, stylized 3D cloud blowing gentle, elegant glowing-white wind swirls across a small green hill, with a couple of glossy autumn leaves floating in the breeze, completely wordless, front-and-center, premium SOTA asset",
    "wind": "A cute, stylized 3D cloud blowing gentle, elegant glowing-white wind swirls across a small green hill, with a couple of glossy autumn leaves floating in the breeze, completely wordless, front-and-center, premium SOTA asset",
    "wissen": "A beautiful, translucent 3D human head silhouette made of blue glass, with a glowing golden lightbulb and a shiny golden key inside the brain area, completely wordless, front-and-center, premium SOTA asset",
    "wo": "A large, glowing 3D red location map pin hovering over a stylized, colorful glass 3D coordinate grid with a tiny gold question mark on top, completely wordless, front-and-center, premium SOTA asset",
    "woher": "A cute 3D parcel package on a small wooden platform, with a glowing golden curved arrow pointing from a far-off tiny globe to the package, completely wordless, front-and-center, premium SOTA asset",
    "wohin": "A cute 3D star character looking down a winding golden path that leads to a giant, glowing golden star on the horizon, pointing its finger forward, completely wordless, front-and-center, premium SOTA asset",
    "wohnen": "A warm, cozy miniature 3D house with a glowing chimney, nestled on a small green grassy hill under a tiny smiling sun, completely wordless, front-and-center, premium SOTA asset",
    "die wohnung": "A beautiful 3D cutaway model of a modern apartment room, featuring a cozy pink sofa, a tiny potted plant, and a glowing window, floating suspended in mid-air, completely wordless, front-and-center, premium SOTA asset",
    "wohnung": "A beautiful 3D cutaway model of a modern apartment room, featuring a cozy pink sofa, a tiny potted plant, and a glowing window, floating suspended in mid-air, completely wordless, front-and-center, premium SOTA asset",
    "wollen": "A cute 3D star character reaching out with both hands towards a magnificent, glowing golden crown floating just out of reach, full of desire and determination, completely wordless, front-and-center, premium SOTA asset",
    "das wort": "A giant, glossy 3D open book with a single, beautiful glowing golden puzzle piece floating above its page, representing a single word, completely wordless, front-and-center, premium SOTA asset",
    "wort": "A giant, glossy 3D open book with a single, beautiful glowing golden puzzle piece floating above its page, representing a single word, completely wordless, front-and-center, premium SOTA asset",
    "wunderbar": "An adorable 3D star character jumping with joy in mid-air, surrounded by sparkling golden confetti, glowing rainbow-colored ribbons, and a giant smiling star halo, completely wordless, front-and-center, premium SOTA asset",
    "zahlen": "A cute 3D hand feeding a glossy golden coin into a beautiful, futuristic cash register with a glowing blue slot, completely wordless, front-and-center, premium SOTA asset",
    "die zeit": "A beautiful, classic 3D gold pocket watch with glowing clock hands spinning slowly, surrounded by sparkling stellar dust, completely wordless, front-and-center, premium SOTA asset",
    "zeit": "A beautiful, classic 3D gold pocket watch with glowing clock hands spinning slowly, surrounded by sparkling stellar dust, completely wordless, front-and-center, premium SOTA asset",
    "die zeitung": "A beautiful, rolled-up 3D newspaper tied with a glossy pink ribbon, floating in mid-air with tiny sparkling stars around it, completely wordless and textless, front-and-center, premium SOTA asset",
    "zeitung": "A beautiful, rolled-up 3D newspaper tied with a glossy pink ribbon, floating in mid-air with tiny sparkling stars around it, completely wordless and textless, front-and-center, premium SOTA asset",
    "die zigarette": "A highly stylized 3D cigarette with a cute, glowing red ban-circle slash overlay, promoting health and smoke-free life, completely wordless, front-and-center, premium SOTA asset",
    "zigarette": "A highly stylized 3D cigarette with a cute, glowing red ban-circle slash overlay, promoting health and smoke-free life, completely wordless, front-and-center, premium SOTA asset",
    "das zimmer": "A beautiful, cozy 3D isometric room model with a pastel-blue wall, a tiny wooden bed, a warm lamp, and a green potted plant, floating suspended, completely wordless, front-and-center, premium SOTA asset",
    "zimmer": "A beautiful, cozy 3D isometric room model with a pastel-blue wall, a tiny wooden bed, a warm lamp, and a green potted plant, floating suspended, completely wordless, front-and-center, premium SOTA asset",
    "der zoll": "A beautiful, modern 3D border crossing barrier gate in red and white stripes, standing next to a sleek 3D magnifying glass examining a suitcase, completely wordless, front-and-center, premium SOTA asset",
    "zoll": "A beautiful, modern 3D border crossing barrier gate in red and white stripes, standing next to a sleek 3D magnifying glass examining a suitcase, completely wordless, front-and-center, premium SOTA asset",
    "zu sein": "A majestic 3D modern arched glass doorway with its double doors tightly closed, with a beautiful glossy red padlock locked across the handles, completely wordless, front-and-center, premium SOTA asset",
    "zufrieden": "An adorable, smiling 3D star character sitting relaxed in a cozy armchair, holding a warm cup of tea, with small golden hearts floating around it, completely wordless, front-and-center, premium SOTA asset",
    "der zug": "A highly polished, sleek 3D red-and-white bullet train speeding along a small curving track, emerging from a tiny mountain portal, completely wordless, front-and-center, premium SOTA asset",
    "zug": "A highly polished, sleek 3D red-and-white bullet train speeding along a small curving track, emerging from a tiny mountain portal, completely wordless, front-and-center, premium SOTA asset",
    "zum beispiel": "A giant, glossy 3D blackboard displaying a simple, beautifully rendered math equation like 1 + 1 = 2 with a golden star sticker, representing an example, completely wordless, front-and-center, premium SOTA asset",
    ...
    "übernachten": "A cozy, stylized 3D bed under a glowing, starry night sky with a cute crescent moon wearing a sleeping cap, completely wordless, front-and-center, premium SOTA asset",
    "überweisen": "A sleek 3D smartphone displaying a glowing golden curved arrow transferring a glossy gold coin into another floating smartphone screen, completely wordless, front-and-center, premium SOTA asset"
}
